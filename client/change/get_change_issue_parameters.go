...
/* GetChangeIssueParams contains all the parameters to send to the API endpoint
   for the get change issue operation.
...
// WithDefaults hydrates default values in the get change issue params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetChangeIssueParams) WithDefaults() *GetChangeIssueParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get change issue params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetChangeIssueParams) SetDefaults() {
