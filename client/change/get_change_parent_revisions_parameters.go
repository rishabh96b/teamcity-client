...
/* GetChangeParentRevisionsParams contains all the parameters to send to the API endpoint
   for the get change parent revisions operation.
...
// WithDefaults hydrates default values in the get change parent revisions params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetChangeParentRevisionsParams) WithDefaults() *GetChangeParentRevisionsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get change parent revisions params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetChangeParentRevisionsParams) SetDefaults() {
