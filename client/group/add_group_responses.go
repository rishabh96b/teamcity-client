...
/* AddGroupOK describes a response with status code 200, with default header values.
...
func (o *AddGroupOK) Error() string {
	return fmt.Sprintf("[POST /app/rest/userGroups][%d] addGroupOK  %+v", 200, o.Payload)
}
