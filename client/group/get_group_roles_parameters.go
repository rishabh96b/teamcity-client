...
// WithGroupLocator adds the groupLocator to the get group roles params
func (o *GetGroupRolesParams) WithGroupLocator(groupLocator string) *GetGroupRolesParams {
	o.SetGroupLocator(groupLocator)
	return o
}

// SetGroupLocator adds the groupLocator to the get group roles params
func (o *GetGroupRolesParams) SetGroupLocator(groupLocator string) {
