...
/* SetParentProjectParams contains all the parameters to send to the API endpoint
   for the set parent project operation.
...
// WithDefaults hydrates default values in the set parent project params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SetParentProjectParams) WithDefaults() *SetParentProjectParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the set parent project params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SetParentProjectParams) SetDefaults() {
