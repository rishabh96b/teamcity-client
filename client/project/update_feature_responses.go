...
/* UpdateFeatureOK describes a response with status code 200, with default header values.
...
func (o *UpdateFeatureOK) Error() string {
	return fmt.Sprintf("[PUT /app/rest/projects/{projectLocator}/projectFeatures/{featureLocator}][%d] updateFeatureOK  %+v", 200, o.Payload)
}
func (o *UpdateFeatureOK) GetPayload() interface{} {
	return o.Payload
}
