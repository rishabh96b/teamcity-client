...
// WithLocator adds the locator to the get features params
func (o *GetFeaturesParams) WithLocator(locator *string) *GetFeaturesParams {
	o.SetLocator(locator)
	return o
}

// SetLocator adds the locator to the get features params
func (o *GetFeaturesParams) SetLocator(locator *string) {
	o.Locator = locator
}

// WithProjectLocator adds the projectLocator to the get features params
func (o *GetFeaturesParams) WithProjectLocator(projectLocator string) *GetFeaturesParams {
	o.SetProjectLocator(projectLocator)
	return o
}

// SetProjectLocator adds the projectLocator to the get features params
func (o *GetFeaturesParams) SetProjectLocator(projectLocator string) {
