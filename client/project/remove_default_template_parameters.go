...
/* RemoveDefaultTemplateParams contains all the parameters to send to the API endpoint
   for the remove default template operation.
...
// WithDefaults hydrates default values in the remove default template params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *RemoveDefaultTemplateParams) WithDefaults() *RemoveDefaultTemplateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the remove default template params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *RemoveDefaultTemplateParams) SetDefaults() {
