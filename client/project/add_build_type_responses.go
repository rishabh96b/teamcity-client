...
/* AddBuildTypeOK describes a response with status code 200, with default header values.
...
func (o *AddBuildTypeOK) Error() string {
	return fmt.Sprintf("[POST /app/rest/projects/{projectLocator}/buildTypes][%d] addBuildTypeOK  %+v", 200, o.Payload)
}
