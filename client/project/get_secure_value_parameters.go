...
/* GetSecureValueParams contains all the parameters to send to the API endpoint
   for the get secure value operation.
...
// WithDefaults hydrates default values in the get secure value params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSecureValueParams) WithDefaults() *GetSecureValueParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get secure value params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSecureValueParams) SetDefaults() {
