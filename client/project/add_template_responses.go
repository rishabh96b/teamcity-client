...
/* AddTemplateOK describes a response with status code 200, with default header values.
...
func (o *AddTemplateOK) Error() string {
	return fmt.Sprintf("[POST /app/rest/projects/{projectLocator}/templates][%d] addTemplateOK  %+v", 200, o.Payload)
}
