...
/* SetUserFieldParams contains all the parameters to send to the API endpoint
   for the set user field operation.
...
// WithDefaults hydrates default values in the set user field params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SetUserFieldParams) WithDefaults() *SetUserFieldParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the set user field params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SetUserFieldParams) SetDefaults() {
