...
/* GetUserPermissionsOK describes a response with status code 200, with default header values.
...
func (o *GetUserPermissionsOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/users/{userLocator}/permissions][%d] getUserPermissionsOK  %+v", 200, o.Payload)
}
func (o *GetUserPermissionsOK) GetPayload() *models.PermissionAssignments {
	return o.Payload
}
