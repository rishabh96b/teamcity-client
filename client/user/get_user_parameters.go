...
// WithUserLocator adds the userLocator to the get user params
func (o *GetUserParams) WithUserLocator(userLocator string) *GetUserParams {
	o.SetUserLocator(userLocator)
	return o
}

// SetUserLocator adds the userLocator to the get user params
func (o *GetUserParams) SetUserLocator(userLocator string) {
