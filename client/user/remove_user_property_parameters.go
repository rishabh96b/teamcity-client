...
/* RemoveUserPropertyParams contains all the parameters to send to the API endpoint
   for the remove user property operation.
...
// WithDefaults hydrates default values in the remove user property params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *RemoveUserPropertyParams) WithDefaults() *RemoveUserPropertyParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the remove user property params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *RemoveUserPropertyParams) SetDefaults() {
