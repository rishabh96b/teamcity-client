...
// WithFields adds the fields to the add user params
func (o *AddUserParams) WithFields(fields *string) *AddUserParams {
	o.SetFields(fields)
	return o
}

// SetFields adds the fields to the add user params
func (o *AddUserParams) SetFields(fields *string) {
	o.Fields = fields
}
