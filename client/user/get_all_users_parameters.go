...
// WithFields adds the fields to the get all users params
func (o *GetAllUsersParams) WithFields(fields *string) *GetAllUsersParams {
	o.SetFields(fields)
	return o
}

// SetFields adds the fields to the get all users params
func (o *GetAllUsersParams) SetFields(fields *string) {
	o.Fields = fields
}

// WithLocator adds the locator to the get all users params
func (o *GetAllUsersParams) WithLocator(locator *string) *GetAllUsersParams {
	o.SetLocator(locator)
	return o
}

// SetLocator adds the locator to the get all users params
func (o *GetAllUsersParams) SetLocator(locator *string) {
	o.Locator = locator
}
