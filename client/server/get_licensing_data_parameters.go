...
/* GetLicensingDataParams contains all the parameters to send to the API endpoint
   for the get licensing data operation.
...
// WithDefaults hydrates default values in the get licensing data params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetLicensingDataParams) WithDefaults() *GetLicensingDataParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get licensing data params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetLicensingDataParams) SetDefaults() {
