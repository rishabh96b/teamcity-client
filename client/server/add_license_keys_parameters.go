...
/* AddLicenseKeysParams contains all the parameters to send to the API endpoint
   for the add license keys operation.
...
// WithDefaults hydrates default values in the add license keys params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *AddLicenseKeysParams) WithDefaults() *AddLicenseKeysParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the add license keys params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *AddLicenseKeysParams) SetDefaults() {
