...
// WithPath adds the path to the download file params
func (o *DownloadFileParams) WithPath(path string) *DownloadFileParams {
	o.SetPath(path)
	return o
}

// SetPath adds the path to the download file params
func (o *DownloadFileParams) SetPath(path string) {
	o.Path = path
}

// WithVcsRootInstanceLocator adds the vcsRootInstanceLocator to the download file params
func (o *DownloadFileParams) WithVcsRootInstanceLocator(vcsRootInstanceLocator string) *DownloadFileParams {
	o.SetVcsRootInstanceLocator(vcsRootInstanceLocator)
	return o
}

// SetVcsRootInstanceLocator adds the vcsRootInstanceLocator to the download file params
func (o *DownloadFileParams) SetVcsRootInstanceLocator(vcsRootInstanceLocator string) {
