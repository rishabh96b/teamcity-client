...
// WithDefaults hydrates default values in the get aliases params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetAliasesParams) WithDefaults() *GetAliasesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get aliases params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetAliasesParams) SetDefaults() {
