...
/* SetBuildTypeFieldParams contains all the parameters to send to the API endpoint
   for the set build type field operation.
...
// WithDefaults hydrates default values in the set build type field params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SetBuildTypeFieldParams) WithDefaults() *SetBuildTypeFieldParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the set build type field params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SetBuildTypeFieldParams) SetDefaults() {
