...
/* GetAllBuildsParams contains all the parameters to send to the API endpoint
   for the get all builds operation.
...
// WithDefaults hydrates default values in the get all builds params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetAllBuildsParams) WithDefaults() *GetAllBuildsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get all builds params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetAllBuildsParams) SetDefaults() {
...
// WithFields adds the fields to the get all builds params
func (o *GetAllBuildsParams) WithFields(fields *string) *GetAllBuildsParams {
	o.SetFields(fields)
	return o
}

// SetFields adds the fields to the get all builds params
func (o *GetAllBuildsParams) SetFields(fields *string) {
	o.Fields = fields
}

// WithLocator adds the locator to the get all builds params
func (o *GetAllBuildsParams) WithLocator(locator *string) *GetAllBuildsParams {
	o.SetLocator(locator)
	return o
}

// SetLocator adds the locator to the get all builds params
func (o *GetAllBuildsParams) SetLocator(locator *string) {
	o.Locator = locator
}
