...
/* GetBuildTagsOK describes a response with status code 200, with default header values.
...
func (o *GetBuildTagsOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/builds/{buildLocator}/tags][%d] getBuildTagsOK  %+v", 200, o.Payload)
}
func (o *GetBuildTagsOK) GetPayload() *models.Tags {
	return o.Payload
}
