...
/* GetCanceledInfoParams contains all the parameters to send to the API endpoint
   for the get canceled info operation.
...
// WithDefaults hydrates default values in the get canceled info params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetCanceledInfoParams) WithDefaults() *GetCanceledInfoParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get canceled info params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetCanceledInfoParams) SetDefaults() {
