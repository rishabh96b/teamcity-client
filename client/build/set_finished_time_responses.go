...
/* SetFinishedTimeOK describes a response with status code 200, with default header values.
...
func (o *SetFinishedTimeOK) Error() string {
	return fmt.Sprintf("[PUT /app/rest/builds/{buildLocator}/finish][%d] setFinishedTimeOK  %+v", 200, o.Payload)
}
