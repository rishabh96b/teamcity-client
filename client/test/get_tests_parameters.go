...
// WithDefaults hydrates default values in the get tests params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetTestsParams) WithDefaults() *GetTestsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get tests params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetTestsParams) SetDefaults() {
