...
type ClientService interface {
	...
	GetTests(params *GetTestsParams, opts ...ClientOption) (*GetTestsOK, error)

	SetTransport(transport runtime.ClientTransport)
}

/*
  GetTest gets a matching test
*/
func (a *Client) GetTest(params *GetTestParams, opts ...ClientOption) (*GetTestOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "getTest",
		Method:             "GET",
		PathPattern:        "/app/rest/tests/{testLocator}",
...
*/
func (a *Client) GetTests(params *GetTestsParams, opts ...ClientOption) (*GetTestsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
