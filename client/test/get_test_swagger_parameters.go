...
// WithFields adds the fields to the get test params
func (o *GetTestParams) WithFields(fields *string) *GetTestParams {
	o.SetFields(fields)
	return o
}

// SetFields adds the fields to the get test params
func (o *GetTestParams) SetFields(fields *string) {
	o.Fields = fields
}

// WithTestLocator adds the testLocator to the get test params
func (o *GetTestParams) WithTestLocator(testLocator string) *GetTestParams {
	o.SetTestLocator(testLocator)
	return o
}

// SetTestLocator adds the testLocator to the get test params
func (o *GetTestParams) SetTestLocator(testLocator string) {
