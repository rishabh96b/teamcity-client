...
// Revision Represents a revision related to a VCS change.
//
...
type Revision struct {
	...
	// vcs branch name
	VcsBranchName string `json:"vcsBranchName,omitempty" xml:"vcsBranchName,attr,omitempty"`
...
func (m *Revision) contextValidateVcsRootInstance(ctx context.Context, formats strfmt.Registry) error {
