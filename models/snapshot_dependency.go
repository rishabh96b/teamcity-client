...
// SnapshotDependency Represents a snapshot dependency relation.
//
...
// ContextValidate validate this snapshot dependency based on the context it is used
...
func (m *SnapshotDependency) contextValidateProperties(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SnapshotDependency) contextValidateSourceBuildType(ctx context.Context, formats strfmt.Registry) error {
