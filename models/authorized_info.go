...
// AuthorizedInfo Represents agent authorization data.
//
...
// ContextValidate validate this authorized info based on the context it is used
func (m *AuthorizedInfo) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AuthorizedInfo) contextValidateComment(ctx context.Context, formats strfmt.Registry) error {
