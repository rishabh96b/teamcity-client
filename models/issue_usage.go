...
// ContextValidate validate this issue usage based on the context it is used
func (m *IssueUsage) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IssueUsage) contextValidateChanges(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IssueUsage) contextValidateIssue(ctx context.Context, formats strfmt.Registry) error {
