...
// AgentRequirement Represents a requirement to agent parameters.
//
...
// ContextValidate validate this agent requirement based on the context it is used
func (m *AgentRequirement) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AgentRequirement) contextValidateProperties(ctx context.Context, formats strfmt.Registry) error {
