...
type Plugin struct {
	...
	// load path
	LoadPath string `json:"loadPath,omitempty" xml:"loadPath,attr,omitempty"`
...
func (m *Plugin) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
