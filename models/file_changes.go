...
// ContextValidate validate this file changes based on the context it is used
func (m *FileChanges) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *FileChanges) contextValidateFile(ctx context.Context, formats strfmt.Registry) error {
